...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		//5. If the robot has crossed the finish line... 
			if(cross == true) {
				JOptionPane.showMessageDialog(null, "Your robot finished! He traveled " + distance);
			}else {
				JOptionPane.showMessageDialog(null, "Your robot did not finish.. He traveled " + distance);
			}
