...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		String guess1 = JOptionPane.showInputDialog("who is this? (first names only)");
		if(guess1.equalsIgnoreCase("arnold")) {
			JOptionPane.showMessageDialog(panel, "You got it correct");
			score+=1;
		}else {
			JOptionPane.showMessageDialog(panel, "That is wrong, it was Arnold");
		}
		showNextImage();
		String guess2 = JOptionPane.showInputDialog("who is this? (first names only)");
		if(guess2.equalsIgnoreCase("leonardo")) {
			JOptionPane.showMessageDialog(panel, "You got it correct");
			score+=1;
		}else {
			JOptionPane.showMessageDialog(panel, "That is wrong, it was Leonardo");
		}
		showNextImage();
		String guess3 = JOptionPane.showInputDialog("who is this? (first names only)");
		if(guess3.equalsIgnoreCase("morgan")) {
			JOptionPane.showMessageDialog(panel, "You got it correct");
			score+=1;
		}else {
			JOptionPane.showMessageDialog(panel, "That is wrong, it was morgan");
		}
		showNextImage();
		String guess4 = JOptionPane.showInputDialog("who is this? (first names only)");
		if(guess4.equalsIgnoreCase("jack")) {
			JOptionPane.showMessageDialog(panel, "You got it correct");
			score+=1;
		}else {
			JOptionPane.showMessageDialog(panel, "That is wrong, it was Jack");
		}
